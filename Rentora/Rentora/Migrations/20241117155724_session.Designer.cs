...
namespace Rentora.Migrations
{
    ...
    [Migration("20241117155724_session")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rentora.Auth.Model.ForumUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Rentora.Data.Entities.Session", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Rentora.Auth.Model.ForumUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Rentora.Data.Entities.Houses", b =>
                {
                    b.HasOne("Rentora.Auth.Model.ForumUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
